...
const Login = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-15 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      <motion.form
      ...
      >
        ...
        <button className="bg-blue-600 w-full cursor-pointer text-white py-2 rounded-full">
